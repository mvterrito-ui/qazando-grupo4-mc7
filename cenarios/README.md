...
| Pasta | Parte |
|---|---|
| [`parte-1-acesso-e-permissao/`](parte-1-acesso-e-permissao/) | Acesso e Permissão |
| [`parte-2-pratica-estruturada/`](parte-2-pratica-estruturada/) | Prática Estruturada |
| [`parte-3-pontuacao-e-comparacao/`](parte-3-pontuacao-e-comparacao/) | Pontuação e Comparação |
| [`parte-4-conteudo-com-ia/`](parte-4-conteudo-com-ia/) | Conteúdo com IA |
